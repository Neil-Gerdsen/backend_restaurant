...
<body class="bg-gray-100">
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4">
        <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
            ...
            <h1 class="text-3xl font-bold mb-6">Restaurant Bewerken</h1>
            ...
            <form action="{{ route('restaurants.update', $restaurant->id) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        required
                    >{{ old('beschrijving', $restaurant->beschrijving) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        ...
                        <input 
                            ...
                            name="prijs" 
                            id="prijs"
                            value="{{ old('prijs', $restaurant->prijs) }}"
                            placeholder="0.00"
                            step="0.01"
                            min="0"
