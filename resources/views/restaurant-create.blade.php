        ...
        <div class="form-card">
            ...
            <form action="{{ route('restaurants.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" placeholder="Naam van het restaurant" required>
                </div>
                
                <div class="form-group">
                    <label for="beschrijving">Beschrijving *</label>
                    <textarea id="beschrijving" name="beschrijving" rows="4" placeholder="Beschrijving" required></textarea>
                </div>
                
                <div class="form-group">
                    <label for="prijs">Prijs *</label>
                    <input type="number" id="prijs" name="prijs" step="0.01" placeholder="0.00" required>
                </div>
